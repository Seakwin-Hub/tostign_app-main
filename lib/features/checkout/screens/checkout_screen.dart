...
import 'package:tostign/common/widgets/address_widget.dart';
...
import 'package:tostign/features/checkout/widgets/checkout_screen_shimmer_view.dart';
import 'package:tostign/features/checkout/widgets/payment_method_bottom_sheet.dart';
import 'package:get/get.dart';
import 'package:tostign/features/checkout/widgets/bottom_section.dart';
import 'package:tostign/features/checkout/widgets/top_section.dart';
  ...
  Future<void> initCall() async {
    ...
    if (widget.storeId == null) {
      ...
      if (_cartList != null && _cartList!.isNotEmpty) {
        ...
        Get.find<CheckoutController>()
            .getOfflineMethodList(_cartList![0]!.item!.storeId.toString());
      }
    }
    if (widget.storeId != null) {
