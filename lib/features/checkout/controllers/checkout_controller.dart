...
import 'package:tostign/features/checkout/domain/models/distance_model.dart';
...
import 'package:tostign/features/checkout/domain/models/timeslote_model.dart';
import 'package:tostign/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:tostign/features/checkout/widgets/order_successfull_dialog.dart';
import 'package:tostign/features/checkout/widgets/partial_pay_dialog_widget.dart';
...
class CheckoutController extends GetxController implements GetxService {
  ...
  Future<void> getOfflineMethodList(String? storeId) async {
    ...
    _offlineMethodList =
        await checkoutServiceInterface.getOfflineMethodList(storeId);
    update();
  }
