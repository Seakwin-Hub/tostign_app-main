...
import 'package:tostign/common/widgets/image_picker_widget.dart';
import 'package:tostign/common/widgets/menu_drawer.dart';
import 'package:tostign/common/widgets/my_text_field.dart';
import 'package:tostign/common/widgets/not_logged_in_screen.dart';
import 'package:tostign/common/widgets/web_menu_bar.dart';
import 'package:tostign/features/profile/widgets/profile_bg_widget.dart';
  ...
  void _updateProfile(ProfileController profileController) async {
    ...
    if (profileController.userInfoModel!.fName == firstName &&
      ...
      UserInfoModel updatedUser =
          UserInfoModel(fName: firstName, lName: lastName, phone: phoneNumber);
