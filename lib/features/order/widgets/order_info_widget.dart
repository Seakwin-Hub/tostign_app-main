...
import 'package:tostign/helper/date_converter.dart';
...
import 'package:tostign/common/widgets/rating_bar.dart';
import 'package:tostign/features/chat/widgets/image_dialog_widget.dart';
import 'package:tostign/features/order/widgets/delivery_details_widget.dart';
import 'package:tostign/features/payment/widgets/offline_info_edit_dialog_widget.dart';
import 'package:tostign/features/order/widgets/order_banner_view_widget.dart';
import 'package:tostign/features/order/widgets/order_item_widget.dart';
import 'package:tostign/features/parcel/widgets/details_widget.dart';
import 'package:tostign/features/review/widgets/review_dialog_widget.dart';
  ...
  return ListTileTheme(
    ...
    child: Theme(
      ...
      child: ExpansionTile(
        ...
        trailing: Icon(
            orderController.isExpanded == true
                ? Icons.expand_more
                : Icons.expand_less,
            size: 18),
        ...
        children: [
              ...
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: Row(children: [
                        Text(
                            '${orderController.trackModel!.offlinePayment!.methodFields![index].inputName.toString().replaceAll('_', ' ').capitalize} : ',
                            style: robotoRegular),
                        Text(
          ...
          Padding(
              ...
              child: Column(
                children: [
                  orderController.trackModel?.offlinePayment?.input?.receipt !=
                          null
                      ? Container(
                          width: MediaQuery.of(context).size.width,
                          height: 300,
                          padding: orderController.trackModel?.offlinePayment
                                      ?.input?.receipt !=
                                  null
                              ? EdgeInsets.all(
                          ...
                          decoration: BoxDecoration(
                            border: Border.all(
                              width: 1,
                              color: orderController.trackModel?.offlinePayment
                                          ?.input?.receipt !=
                                      null
                                  ? Theme.of(context).primaryColor
                          ...
                          child: ClipRRect(
                              borderRadius:
                                  BorderRadius.circular(Dimensions.radiusLarge),
                              child: orderController.trackModel?.offlinePayment
                                          ?.input?.receipt !=
                                      null
                                  ? CustomImage(
                                      image: orderController.trackModel!
                                              .offlinePayment?.input!.receipt ??
                                          '',
                                      width: 200,
                                      fit: BoxFit.fill,
                                    )
                                  : Column(
                                      children: [
                                        ...
                                        TransactionErrorWidget(
                                          ...
                                          color: Colors.red,
                                          text: "transaction_image_error".tr,
                                        ),
                                      ],
                                    )),
                        )
          ...
          //   physics: const NeverScrollableScrollPhysics(),
          //   itemCount:
          //       orderController.trackModel!.offlinePayment!.inputs!.length,
          //   itemBuilder: (context, index) {
          //     Input data =
          //         orderController.trackModel!.offlinePayment!.inputs![index];
          //     // data.receipt = null;
          //     return Padding(
          //         padding: const EdgeInsets.only(
          //             bottom: Dimensions.paddingSizeExtraSmall),
          ...
          //               width: MediaQuery.of(context).size.width,
          //               height: 300,
          //               padding: data.receipt != null
          //                   ? EdgeInsets.all(Dimensions.paddingSizeDefault - 10)
          //                   : EdgeInsets.all(50),
          //               decoration: BoxDecoration(
          //                 border: Border.all(
          //                   width: 1,
          //                   color: data.receipt != null
          //                       ? Theme.of(context).primaryColor
          //                       : Theme.of(context).primaryColorDark,
          //                 ),
          //                 borderRadius:
          ...
          //                                     50),
          //                         child: Image(
          //                           image: AssetImage(Images.imgNotFound),
          //                           fit: BoxFit.contain,
          //                           width: 100,
          //                         ),
          //                       ),
...
Container orderInfoError(BuildContext context, OrderController orderController,
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      border: Border.all(
        width: 1,
        color:
            orderController.trackModel?.offlinePayment?.input?.receipt != null
                ? Theme.of(context).primaryColor
                : Theme.of(context).primaryColorDark,
      ),
