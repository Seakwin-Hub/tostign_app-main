...
class OfflinePayment {
  ...
  OfflinePayment.fromJson(Map<String, dynamic> json) {
    if (json['input'] != null) {
      ...
      json['input'].forEach((key, v) {
        if (key == "receipt") {
          input!.receipt = v;
        }
        if (key == "0") {
          input!.referrence = UserReferrence.fromJson(v);
        }
      });
    }
...
class Input {
  String? receipt;
  UserReferrence? referrence;

  Input({this.referrence, this.receipt});

  Input.fromJson(Map<String, dynamic> json) {
    receipt = json['receipt'];
    referrence = json['0'] != null ? UserReferrence.fromJson(json['0']) : null;
  }
...
class UserReferrence {
  String? userInput;
  String? userData;

  UserReferrence({this.userData, this.userInput});

  UserReferrence.fromJson(Map<String, dynamic> json) {
