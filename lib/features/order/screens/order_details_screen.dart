...
import 'package:tostign/features/order/domain/models/order_details_model.dart';
...
// import 'package:tostign/features/checkout/widgets/offline_success_dialog.dart';
import 'package:tostign/features/order/widgets/cancellation_dialogue_widget.dart';
import 'package:tostign/features/order/widgets/order_calcuation_widget.dart';
import 'package:tostign/features/order/widgets/order_info_widget.dart';
import 'package:tostign/features/review/screens/rate_review_screen.dart';
...
class OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  void _loadData(BuildContext context, bool reload) async {
    ...
    if (Get.find<OrderController>().isExpanded != false) {
      Get.find<OrderController>().expandedUpdate(false);
    }
  }
                  ...
                  ((order.orderStatus == 'pending' &&
                      ...
                      ? Expanded(
                          child: CustomButton(
                            ...
                            onPressed: () async {
                              if (orderController.trackModel?.offlinePayment
                                      ?.input?.receipt !=
                                  null) {
                                _timer?.cancel();
                                await Get.toNamed(
                                ...
                                showCustomSnackBar(
                                    "Your payment info is not correct !");
                              }
                            },
                          ),
                        )
