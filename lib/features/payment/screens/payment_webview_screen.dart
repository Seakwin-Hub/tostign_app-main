...
import 'package:tostign/features/checkout/widgets/payment_failed_dialog.dart';
import 'package:tostign/features/wallet/widgets/fund_payment_dialog_widget.dart';
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            InAppWebView(
              initialUrlRequest:
                  URLRequest(url: WebUri(Uri.parse(selectedUrl).toString())),
