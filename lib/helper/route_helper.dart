...
import 'package:tostign/features/blog/screens/blog_screen.dart';
import 'package:tostign/features/brands/screens/brands_product_screen.dart';
import 'package:tostign/features/brands/screens/brands_screen.dart';
import 'package:tostign/features/business/screens/subscription_payment_screen.dart';
import 'package:tostign/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:tostign/features/loyalty/screens/loyalty_screen.dart';
import 'package:tostign/features/refer_and_earn/screens/refer_and_earn_screen.dart';
import 'package:tostign/features/splash/controllers/splash_controller.dart';
import 'package:tostign/features/notification/domain/models/notification_body_model.dart';
...
import 'package:tostign/features/item/domain/models/basic_campaign_model.dart';
import 'package:tostign/features/chat/domain/models/conversation_model.dart';
...
import 'package:tostign/features/parcel/domain/models/parcel_category_model.dart';
import 'package:tostign/features/store/domain/models/store_model.dart';
import 'package:tostign/features/address/screens/add_address_screen.dart';
import 'package:tostign/features/address/screens/address_screen.dart';
import 'package:tostign/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:tostign/features/auth/screens/sign_in_screen.dart';
import 'package:tostign/features/auth/screens/sign_up_screen.dart';
import 'package:tostign/features/auth/screens/store_registration_screen.dart';
import 'package:tostign/features/category/screens/category_screen.dart';
import 'package:tostign/features/location/screens/map_screen.dart';
import 'package:tostign/features/store/screens/campaign_screen.dart';
import 'package:tostign/helper/address_helper.dart';
import 'package:tostign/helper/auth_helper.dart';
import 'package:tostign/util/app_constants.dart';
import 'package:tostign/util/html_type.dart';
import 'package:tostign/common/widgets/image_viewer_screen.dart';
import 'package:tostign/common/widgets/not_found.dart';
import 'package:tostign/features/cart/screens/cart_screen.dart';
import 'package:tostign/features/category/screens/category_item_screen.dart';
import 'package:tostign/features/chat/screens/chat_screen.dart';
import 'package:tostign/features/chat/screens/conversation_screen.dart';
import 'package:tostign/features/checkout/screens/checkout_screen.dart';
import 'package:tostign/features/payment/screens/offline_payment_screen.dart';
import 'package:tostign/features/checkout/screens/order_successful_screen.dart';
import 'package:tostign/features/payment/screens/payment_screen.dart';
import 'package:tostign/features/payment/screens/payment_webview_screen.dart';
import 'package:tostign/features/coupon/screens/coupon_screen.dart';
import 'package:tostign/features/dashboard/screens/dashboard_screen.dart';
import 'package:tostign/features/favourite/screens/favourite_screen.dart';
import 'package:tostign/features/flash_sale/screens/flash_sale_details_screen.dart';
import 'package:tostign/features/item/screens/item_campaign_screen.dart';
import 'package:tostign/features/item/screens/item_details_screen.dart';
import 'package:tostign/features/item/screens/popular_item_screen.dart';
import 'package:tostign/features/verification/screens/forget_pass_screen.dart';
import 'package:tostign/features/verification/screens/new_pass_screen.dart';
import 'package:tostign/features/verification/screens/verification_screen.dart';
import 'package:tostign/features/html/screens/html_viewer_screen.dart';
import 'package:tostign/features/interest/screens/interest_screen.dart';
import 'package:tostign/features/language/screens/language_screen.dart';
import 'package:tostign/features/location/screens/access_location_screen.dart';
import 'package:tostign/features/location/screens/pick_map_screen.dart';
import 'package:tostign/features/notification/screens/notification_screen.dart';
import 'package:tostign/features/onboard/screens/onboarding_screen.dart';
import 'package:tostign/features/order/screens/guest_track_order_screen.dart';
import 'package:tostign/features/order/screens/order_details_screen.dart';
import 'package:tostign/features/order/screens/order_screen.dart';
import 'package:tostign/features/order/screens/order_tracking_screen.dart';
import 'package:tostign/features/order/screens/refund_request_screen.dart';
import 'package:tostign/features/parcel/screens/parcel_category_screen.dart';
import 'package:tostign/features/parcel/screens/parcel_location_screen.dart';
import 'package:tostign/features/parcel/screens/parcel_request_screen.dart';
import 'package:tostign/features/profile/screens/profile_screen.dart';
import 'package:tostign/features/profile/screens/update_profile_screen.dart';
import 'package:tostign/features/store/screens/all_store_screen.dart';
import 'package:tostign/features/store/screens/store_item_search_screen.dart';
import 'package:tostign/features/store/screens/store_screen.dart';
import 'package:tostign/features/review/screens/review_screen.dart';
import 'package:tostign/features/search/screens/search_screen.dart';
import 'package:tostign/features/splash/screens/splash_screen.dart';
import 'package:tostign/features/support/screens/support_screen.dart';
import 'package:tostign/features/update/screens/update_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:tostign/features/wallet/screens/wallet_screen.dart';
...
class RouteHelper {
  ...
  static String getOfflinePaymentScreen({
    ...
    String data = base64Encode(encoded);
    return '$offlinePaymentScreen?order_body=$data&zone_id=$zoneId&total=$total&max_cod_amount=$maxCodOrderAmount&from_cart=$fromCart&cod_active=$isCodActive&for_parcel=$forParcel&store-id=$storeId';
  }
